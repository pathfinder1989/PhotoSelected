...
- (void)setAssetsGroup:(ALAssetsGroup *)assetsGroup
{
    ...
    if ([assetsGroup numberOfAssets] >= 3) {
        range = NSMakeRange(([assetsGroup numberOfAssets] - 3), 3);
    }else{
        range = NSMakeRange(0, [assetsGroup numberOfAssets]);
    }
    ...
    NSMutableArray *reverseArr = [NSMutableArray arrayWithArray:[[thumbnailImages reverseObjectEnumerator] allObjects]];
    thumbnailImages = reverseArr;
